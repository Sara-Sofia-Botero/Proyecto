                  ...
                  <div class="card">
                    ...
                    <div class="card-body" id="formulario">
                      <form class="form-horizontal" method="POST" action="crud/registrar_factura.php">
                        ...
                        <div class="line"></div>
                        <div class="form-group row">
                          <label class="col-sm-3 form-control-label">Lectura actual (m³)</label>
                          <div class="col-sm-9">
                        ...
                        <div class="line"></div>
                        <div class="form-group row">
                          <label class="col-sm-3 form-control-label">Lectura anterior (m³)</label>
                          <div class="col-sm-9">
                        ...
                        <div class="line"></div>
                        <div class="form-group row">
                          <label class="col-sm-3 form-control-label">Consumo en  m³</label>
                          <div class="col-sm-9">
                        ...
                        <div class="line"></div>
                        <div class="form-group row">
                          <label class="col-sm-3 form-control-label">Vertimiento en m³</label>
                          <div class="col-sm-9">
                        ...
                        <div class="line"></div>
                        <div class="form-group row">
                          <label class="col-sm-3 form-control-label">Promedio en  m³</label>
                          <div class="col-sm-9">

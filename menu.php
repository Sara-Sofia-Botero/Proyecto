 ...
 <div class="b1">
       ...
       <div class="enlaces">
           <ul>
               ...
               <li><strong>Lectura actual (m3):</strong> <?php echo $r["lectura_actual"]; ?></li>
               <li><strong>Lectura anterior (m3):</strong> <?php echo $r["lectura_anterior"]; ?></li>
